...
require('rxjs/Rx');
var ArchivedHumanTaskService = (function () {
    function ArchivedHumanTaskService(http, bonitaConifg, bonitaUtils) {
        this.http = http;
    ...
    ArchivedHumanTaskService.prototype.getCompletedByCurrentUser = function (id) {
    ...
    ArchivedHumanTaskService.prototype.handleError = function (error) {
        var errMsg = error.status ? error.status + " - " + error.statusText :
            'Server error';
        console.error(errMsg); // log to console instead
        return Observable_1.Observable.throw(errMsg);
    };
    ArchivedHumanTaskService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http, bonita_config_1.BonitaConfig, bonita_utils_1.BonitaUtils])
    ], ArchivedHumanTaskService);
    return ArchivedHumanTaskService;
}());
exports.ArchivedHumanTaskService = ArchivedHumanTaskService;
//# sourceMappingURL=archived-human-task.service.js.map