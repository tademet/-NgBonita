 ...
 */
var ArchivedProcessInstanceService = (function () {
    /**
     ...
     */
    function ArchivedProcessInstanceService(http, bonitaConifg, bonitaUtils) {
        this.http = http;
     ...
     * @returns
     */
    ArchivedProcessInstanceService.prototype.getStartedByCurrentUser = function () {
     ...
     * @returns
     */
    ArchivedProcessInstanceService.prototype.getByCaseId = function (id) {
        var options = new http_1.RequestOptions({
            method: http_1.RequestMethod.Get,
    ...
    ArchivedProcessInstanceService.prototype.handleError = function (error) {
        var errMsg = error.status ? error.status + " - " + error.statusText :
            'Server error';
        console.error(errMsg); // log to console instead
        return Observable_1.Observable.throw(errMsg);
    };
    ArchivedProcessInstanceService = __decorate([
        core_1.Injectable(), 
    ...
    return ArchivedProcessInstanceService;
}());
exports.ArchivedProcessInstanceService = ArchivedProcessInstanceService;
//# sourceMappingURL=archived-process-instance.service.js.map